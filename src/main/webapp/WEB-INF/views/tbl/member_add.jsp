...
<table style="" width="100%" id="mytab"  border="1" class="et1">  
  ...
  <tr> 
    ...
    <input type="text" id="xxlrbt" name="name" style="width:100px" value=""></td>  
    </tr>
    <tr>  
    <td align="right" width="30%">职位：</td>  
    <td align="left" colspan="3">
    <input type="text" id="xxlrbt" name="zw" style="width:100px" value=""></td>
    </tr>
  <tr>  
    <td align="right" width="30%">areaid：</td>  
    <td align="left" colspan="3">
    <input type="text" id="xxlrgqqx" name="areaid" style="width:100px" value=""></td>  
  </tr>
  <tr>
  	<td align="right" width="30%">depteid：</td>
  	<td><input type="text" id="depteid" name="depteid" style="width:100px" value=""></td>
  </tr>
  <tr>
  	<td align="right" width="30%">passwd：</td>
  	<td><input type="text" id="passwd" name="passwd" style="width:100px" value=""></td>
  </tr>
  <tr>
  	<td align="right" width="30%">keyno：</td>
  	<td><input type="text" id="keyno" name="keyno" style="width:100px" value=""></td>
  </tr>
  <tr>
  	<td align="right" width="30%">px：</td>
  	<td><input type="text" id="px" name="px" style="width:100px" value=""></td>
  </tr>
  <tr>
  	<td align="right" width="30%"><input type="submit" value="add" name="Submit"/>
